<SCRIPT LANGUAGE=VBScript RUNAT=Server>
 ...
 FUNCTION fValidPath (ByVal strPath)
  If InStr(1, strPath, "/ASPSamp/", 1) Then
    fValidPath = 1
  Else
    fValidPath = 0
  End If
...
<TABLE>
<TR>
<TD><IMG SRC="/AdvWorks/multimedia/images/asp.gif" WIDTH=200 HEIGHT=93 BORDER=0 ALT="Active Server Page logo"></TD>
...
<BR>
Go Back to <a href="/ASPSamp/Samples/Samples.htm">main samples page</A>
<hr>
<%
