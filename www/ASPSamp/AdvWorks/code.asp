<SCRIPT LANGUAGE=VBScript RUNAT=Server>
 ...
 FUNCTION fValidPath (ByVal strPath)
  If InStr(1, strPath, "/AdvWorks/", 1) Or InStr(1, strPath, "/ASPSamp/", 1) Then
    fValidPath = 1
  Else
    fValidPath = 0
  End If
...
<IMG SRC="/AdvWorks/multimedia/images/asp.GIF" WIDTH=200 HEIGHT=93 BORDER=0 ALT="Active Server Page logo">
<B>View ASP Source</B>
<HR>
