<HTML>
<HEAD>
<TITLE>Adventure Works Sales by Customer Listing</TITLE></HEAD>
...
<TD COLSPAN=3>
<FONT SIZE=4 FACE="Verdana, Arial, Helvetica" COLOR="#800000">Sales by Customer</FONT>
<HR SIZE=4>
</TD>
</TR>
...
Set RS = Conn.Execute("{Call SalesByCustomer}")
TotalUnits = 0
TotalSales = 0
%>
